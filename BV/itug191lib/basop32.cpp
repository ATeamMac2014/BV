...
/*___________________________________________________________________________
 |                                                                           |
 |   Function Name : round30To16                                                   |
 |                                                                           |
 |   Purpose :                                                               |
 |                                                                           |
 |   round30To16 the lower 16 bits of the 32 bit input number into the MS 16 bits  |
 |   with saturation. Shift the resulting bits right by 16 and return the 16 |
 |   bit number:                                                             |
 |               round30To16(L_var1) = extract_h(L_add(L_var1,32768))              |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
 ...
 |___________________________________________________________________________|
*/
Word16 round30To16 (Word32 L_var1)
{
    Word16 var_out;
    Word32 L_rounded;
    ...
    multiCounter[currCounter].extract_h--;
    multiCounter[currCounter].round30To16++;
#endif
    return (var_out);
}
...
Word16 mult_r (Word16 var1, Word16 var2)
{
    ...
    L_product_arr += (Word32) 0x00004000L;      /* round30To16 */
...
/*___________________________________________________________________________
 ...
 |                                                                           |
 |   Multiply var1 by var2 and shift the result left by 1. Add the 32 bit    |
 |   result to L_var3 with saturation. round30To16 the LS 16 bits of the result    |
 |   into the MS 16 bits with saturation and shift the result right by 16.   |
 |   Return a 16 bit result.                                                 |
 |            mac_r(L_var3,var1,var2) = round30To16(L_mac(L_var3,var1,var2))       |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
...
/*___________________________________________________________________________
 ...
 |                                                                           |
 |   Multiply var1 by var2 and shift the result left by 1. Subtract the 32   |
 |   bit result from L_var3 with saturation. round30To16 the LS 16 bits of the res-|
 |   ult into the MS 16 bits with saturation and shift the result right by   |
 |   16. Return a 16 bit result.                                             |
 |            msu_r(L_var3,var1,var2) = round30To16(L_msu(L_var3,var1,var2))       |
 |                                                                           |
 |   Complexity weight : 1                                                   |
 |                                                                           |
 |   Inputs :                                                                |
